...
public class ModResearchCosts
{
    ...
    public static DeferredHolder<ResearchCostEntry, ResearchCostEntry> simpleItemCost;
    public static DeferredHolder<ResearchCostEntry, ResearchCostEntry> listItemCost;
    public static DeferredHolder<ResearchCostEntry, ResearchCostEntry> tagItemCost;
