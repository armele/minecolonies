...
{
    public static final DeferredRegister<ResearchCostEntry> DEFERRED_REGISTER = DeferredRegister.create(CommonMinecoloniesAPIImpl.RESEARCH_COST_TYPES, Constants.MOD_ID);
    static
    {
     ...
     */
    private static DeferredHolder<ResearchCostEntry, ResearchCostEntry> create(
